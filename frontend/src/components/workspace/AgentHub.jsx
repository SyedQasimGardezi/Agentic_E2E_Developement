...
const AgentHub = ({ tickets, progress, expandedParents, onToggle, activeAgent, activeView }) => {
                ...
                <div style={{
                    ...
                    {step.total_tests > 0 && (
                        <span style={{
                            ...
                            {step.passed_tests || 0}/{step.total_tests}
                        </span>
                    )}
                </div>
                {step.details && step.status === 'active' && (
                    <div style={{fontSize: '0.7rem', color: 'var(--text-muted)', marginTop: 2, wordBreak: 'break-word', lineHeight: 1.3}}>{step.details}</div>
                )}
            </div>
  ...
  return (
    <div className="agent-hub-container" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      {activeView === 'overview' ? (
        <div className="agent-hub">
          ...
          <div className="hub-column">
            ...
            <div className="agent-card" style={{height: 'calc(100vh - 180px)', padding: '20px'}}>
          ...
          {/* Column 2: Developer/QA Implementation */}
          <div className="hub-column">
            <div className="hub-column-header">
              <span className="hub-column-title">
                {activeAgent === 'qa' ? (
                    <>
                        <Activity size={20} color="var(--accent-qa)" />
                        QUALITY ASSURANCE
                    </>
                ) : (
                    <>
          ...
          <div className="hub-column">
            ...
            <div className="agent-card" style={{height: 'calc(100vh - 180px)', background: '#0f172a', padding: 0, overflow: 'hidden'}}>
